function getMatchWork(){
	
	//Chargement de la liste des liasses à affecter au matching
	$.ajax({
		
		url: './models/Admin_matching_getAgent.php',
		type: 'POST',
		data: '',
		dataType: 'json',
		success : function(data){
			...
			if(data[0] > 0){
				...
				$('#match-table').DataTable().clear().draw(false);
				var i = 0,
					j = data[0] * 7,
					stat = ''
				;
