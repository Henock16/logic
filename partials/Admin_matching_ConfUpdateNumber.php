<div class="modal fade" id="modal-Upconfnum" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog" style="width:750px">
		<div class="modal-content" style="border-radius: 3px;">
			<form id="Upconfnum-form" action="#">
				<div class="modal-header">
					...
					<input id="upidconf" type="hidden" value="">
				</div>
				<div class="modal-body" style="max-height: 1000px; overflow-y:auto;">
					
					<p id="Upconftext" style="font-weight: bold; font-size: 18px; text-align: center"></p>
					<div class="col-xs-12" style="font-size: 18px">	
						
						<div class="form-group">
							<div class="col-xs-4"></div>
							<div class="col-xs-4">
								<select class="form-control pull-right" id="numberforconf" name="numberforconf">
