		...
		<div class="modal-dialog" style="width:600px">
			<div class="modal-content" style="border-radius: 3px;">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" style="font-weight: bold;"><i class="fa fa-info-circle fa-lg"></i>&nbsp;Modification du certificat</h4>
					<input type="hidden" id="redit-idcertif" value="" />
				...
				<div class="modal-body" style="max-height: 1000px; overflow-y:auto;">
					...
					<div class="col-xs-12 text-center" style="font-size: 18px;">
						<p>Voulez-vous vraiment <b>demander la modification</b> du certificat ?</p>
						<p id="redit-numcertif" style="font-weight: bold;"></p>
					</div>
