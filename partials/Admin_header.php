						...
						<ul class="nav navbar-nav">
							<li class="dropdown messages-menu" style="font-size: 16px;">
								<a href="#" class="dropdown-toggle" >
									...
									<span id="h" style="text-align:center; display:inline-block; font-size: 16px;color: black; width: 20px;height: 30%; background-color:white; border-radius: 2px; box-shadow: -1px 1px 2px 1px rgba(85, 85, 85, 0.3) inset;">
										<?php echo($hour);?>
									</span>

									<span style="font-size: 16px; font-weight:500; color:rgb(98, 98, 98);">&nbsp;:&nbsp;</span>
									<span id="m" style="text-align:center; display:inline-block;font-size: 16px;color: black; width: 20px;height: 30%; background-color:white; border-radius: 2px; box-shadow: -1px 1px 2px 1px rgba(85, 85, 85, 0.3) inset;">
										<?php echo($min);?>
									</span>

									<span style="font-size: 16px; font-weight:500; color:rgb(98, 98, 98);">&nbsp;:&nbsp;</span>
									<span id="s" style="text-align:center; display:inline-block;font-size: 16px;color: white; width: 20px;height: 30%; background-color:#C2C2C2; border-radius: 2px; box-shadow: -1px 1px 2px 1px rgba(85, 85, 85, 0.3) inset">
										<?php echo($sec);?>
									</span>
								</a>
							</li>
				...
				<section class="sidebar">
					...
					<div class="user-panel" style="min-height: 95px;">
						...
						<div class="pull-left info">
							...
							<a href="#"><i class="fa fa-circle text-success" id="LED" style="color:#00A65A"></i> Connect&eacute;</a><br/>
