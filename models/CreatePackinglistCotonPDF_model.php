	...
	class PDF extends FPDF{
		...
		function piedpage($n){
			...
			if($_SESSION['A_R'] == 2){
				...
				$this -> Image('../assets/images/a-r.png', 110, 268, 40);
		...
		function info_expor($Nu,$Cp,$Rc,$Ex,$Eg,$Pr,$Tr,$Nd,$Nic,$Nif,$De,$Dd,$Df,$Dt,$Na){
			...
			$this -> Ln(15);
			$this -> SetFont('Courier','B',8);
			$this -> Cell(40,5,'Campagne',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(50,5,$Cp,$border,0,'L');
			$this -> SetFillColor(255,255,255);
			$this -> Cell(10,5,'','L',0,'C',1);
			$this -> SetFont('Courier','B',8);
			$this -> Cell(50,5,utf8_decode('N° Instruction Client'),$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(40,5,$Nic,$border,0,'L');
			$this -> Cell(5,5,'','L',0,'C',1);
			$this -> Ln();
			$this -> SetFont('Courier','B',8);
			$this -> Cell(40,5,utf8_decode('Récolte'),$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(50,5,$Rc,$border,0,'L');
			$this -> Cell(10,5,'','L',0,'C',1);
			$this -> SetFont('Courier','B',8);
			$this -> Cell(50,5,utf8_decode('N° Instruction Fournisseur'),$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(40,5,$Nif,$border,0,'L');
			$this -> Cell(5,5,'','L',0,'C',1);
			$this -> Ln();
			$this -> SetFont('Courier','B',8);
			$this -> Cell(40,5,'Exportateur',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(50,5,utf8_decode($Ex),$border,0,'L');
			$this -> Cell(10,5,'','L',0,'C',1);
			$this -> SetFont('Courier','B',8);
			$this -> Cell(50,5,'Destinataire',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(40,5,utf8_decode($De),$border,0,'L');
			$this -> Cell(5,5,'','L',0,'C',1);
			$this -> Ln();
			$this -> SetFont('Courier','B',8);
			$this -> Cell(40,5,'Egreneur',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(50,5,utf8_decode($Eg),$border,0,'L');
			$this -> Cell(10,5,'','L',0,'C',1);
			$this -> SetFont('Courier','B',8);
			$this -> Cell(50,5,utf8_decode('Date début empotage'),$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(40,5,$Dd,$border,0,'L');
			$this -> Cell(5,5,'','L',0,'C',1);
			$this -> Ln();
			$this -> SetFont('Courier','B',8);
			$this -> Cell(40,5,'Type de Produit',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(50,5,$Pr,$border,0,'L');
			$this -> Cell(10,5,'','L',0,'C',1);
			$this -> SetFont('Courier','B',8);
			$this -> Cell(50,5,'Date fin empotage',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(40,5,$Df,$border,0,'L');
			$this -> Cell(5,5,'','L',0,'C',1);
			$this -> Ln();
			$this -> SetFont('Courier','B',8);
			$this -> Cell(40,5,'Transitaire',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(50,5,utf8_decode($Tr),$border,0,'L');
			$this -> Cell(10,5,'','L',0,'C',1);
			$this -> SetFont('Courier','B',8);
			$this -> Cell(50,5,'Destination',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(40,5,utf8_decode($Dt),$border,0,'L');
			$this -> Cell(5,5,'','L',0,'C',1);
			$this -> Ln();
			$this -> SetFont('Courier','B',8);
			$this -> Cell(40,5,utf8_decode('N° Dossier'),$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(50,5,$Nd,$border,0,'L');
			$this -> Cell(10,5,'','L',0,'C',1);
			$this -> SetFont('Courier','B',8);
			$this -> Cell(50,5,'Navire',$border,0,'L');
			$this -> SetFont('Courier','',8);
			$this -> Cell(40,5,utf8_decode($Na),$border,0,'L');
			$this -> Cell(5,5,'','L',0,'C',1);
			$this -> Ln(10);
		}
		...
		function info_pesee($id){
			...
			$this -> Cell(12,4,'Nbre',$border2,0,$pos,1);
			...
			$this -> Cell(12,4,'Balles',$border3,0,$pos,1);
			$this -> Cell(12,4,'Balles',$border3,0,$pos,1);
			...
			while($data = $query -> fetch()){
				...
				$this -> Cell(20,5,dateFr($data['DATE_PESEE']),$border,0,'L');
				$this -> Cell(10,5,$typecont.'\'',$border,0,'C');
				$this -> Cell(20,5,$data['NUM_CONTENEUR'],$border,0,'L');
				...
				$this -> Cell(12,5,number_format($data['NB_EMB'], 0,',',' '),$border,0,'R');
			...
			$this -> Cell(12,5,number_format($somNb, 0,',',' '),$border,0,'R');
		...
		function signature($nom,$pren,$fon,$tel){
			...
			$this -> SetFont('Courier','',8);
			$this -> Cell(190,10,utf8_decode($nom).' '.utf8_decode($pren),0,0,'R');
			$this -> Ln(5);
			$this -> Cell(50,10,"Packing List".utf8_decode(" édité ")."le : ".date("d/m/Y").utf8_decode(" à ").date("H:i:s"),0,0,'L');
			$this -> Cell(140,10,utf8_decode($fon).' / '.$tel,0,0,'R');
		}
	}
?>
