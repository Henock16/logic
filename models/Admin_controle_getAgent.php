<?php
	...
	$tab[$i] = 0;
	if($_SESSION['ROLE']==2){
		$query1 = $bdd -> query("SELECT ID_UTIL, NOM, PRENOM, STAT_COMPTE, ID_VILLE FROM utilisateur WHERE TYPE_COMPTE = 2 AND ID_VILLE=".$_SESSION['ID_VILLE']);
		$query1 -> execute();
	}
	elseif($_SESSION['ROLE']!=2){
		$query1 = $bdd -> query("SELECT ID_UTIL, NOM, PRENOM, STAT_COMPTE, ID_VILLE FROM utilisateur WHERE TYPE_COMPTE = 2");
		$query1 -> execute();
	}
